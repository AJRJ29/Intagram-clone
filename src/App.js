...
function App() {
  ...
  return (
    <div className="app">
      ...
      >
        <div style={modalStyle} className={classes.paper}>
          <form className="app__signUp">
            <center>
              <img src="https://www.instagram.com/static/images/web/mobile_nav_type_logo.png/735145cfe0a4.png" alt="" className="app__headerImg" />
            </center>
            <Input 
      ...
      {/* optionalals, if this is not there dont freak out and break */}
      {user?.displayName ? (
